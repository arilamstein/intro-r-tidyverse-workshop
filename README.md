...
4. Double-click the file `intro-f-tidyverse.Rproj` in your local copy of this repository. That should open up RStudio.
5. Run the following command in your R console:
